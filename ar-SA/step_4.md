...
استخدم أي مفاتيح ترغب في زيادة أو تقليل موقع المظاهر (الكائن) باستخدام`تغيير x بواسطة` و{:calss="block3motion"}`غيّر y حسب`{:calss="block3motion"} اللبنات (الكود البرمجي)
